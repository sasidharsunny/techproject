...
<div class="row content">
          ...
          <h1 class="chooseh1" style={{color:"#000",fontSize:"2.2rem",  fontWeight: "bold !important",textAlign:"left"}} > Choose <span class="text-blue">Right Internship</span> to your <span class="text-blue"></span>career </h1><br/>
